...
import { downloadVariantRecords, processVariantRecord } from './variant';
import { getPublication } from './publication';


const { civic: SOURCE_DEFN, ncit: NCIT_SOURCE_DEFN } = sourceDefns;
class NotImplementedError extends kbParser.error.ErrorMixin {}
...
const specs = { validateEvidenceSpec };
export  {
    specs,
    translateRelevance,
};
