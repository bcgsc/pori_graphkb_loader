...
import _trials from '../clinicaltrialsgov';
import _pubmed from '../entrez/pubmed';
import _asco from '../asco';
import _gene from '../entrez/gene';
import { uploadFromJSON } from '../ontology';

import sourceDefns from '../sources';


const { cgi: SOURCE_DEFN } = sourceDefns;
const HEADER = {
...
const uploadFile = async ({ conn, filename, errorLogPrefix }) => {
    ...
    const errorList: {error: any, errorMessage: string, index: number, row: any}[] = [];
