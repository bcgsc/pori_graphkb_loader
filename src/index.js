...
IMPORT_MODULES.cosf = require('./cosmicFusions');
...
IMPORT_MODULES.drugOntology = require('./drugOntology');
IMPORT_MODULES.ensembl = require('./ensembl');
IMPORT_MODULES.fdaSrs = require('./fdaSrs');
...
IMPORT_MODULES.tcgaFusions = require('./tcgaFusions');
