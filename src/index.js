...
IMPORT_MODULES.cancerhotspots = require('./knowledgebases/cancerhotspots');
IMPORT_MODULES.cgi = require('./knowledgebases/cancergenomeinterpreter');
IMPORT_MODULES.civic = require('./knowledgebases/civic');
IMPORT_MODULES.cosmic = require('./knowledgebases/cosmic');
IMPORT_MODULES.cosf = require('./knowledgebases/cosmicFusions');
IMPORT_MODULES.ctg = require('./clinicaltrialsgov');
IMPORT_MODULES.dgidb = require('./drugs/dgidb');
IMPORT_MODULES.diseaseOntology = require('./diseaseOntology');
IMPORT_MODULES.docm = require('./knowledgebases/docm');
IMPORT_MODULES.drugbank = require('./drugs/drugbank');
IMPORT_MODULES.drugOntology = require('./drugs/drugOntology');
IMPORT_MODULES.ensembl = require('./ensembl');
IMPORT_MODULES.fdaSrs = require('./drugs/fdaSrs');
IMPORT_MODULES.hgnc = require('./hgnc');
IMPORT_MODULES.iprkb = require('./knowledgebases/ipr');
IMPORT_MODULES.ncit = require('./ncit');
IMPORT_MODULES.oncokb = require('./knowledgebases/oncokb');
IMPORT_MODULES.oncotree = require('./oncotree');
IMPORT_MODULES.ontology = require('./ontology');
IMPORT_MODULES.refseq = require('./refseq');
IMPORT_MODULES.sequenceOntology = require('./sequenceOntology');
